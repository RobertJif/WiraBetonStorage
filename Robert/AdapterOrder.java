...
public class AdapterOrder extends BaseAdapter {
    ...
    public AdapterOrder(Context context, ArrayList<Barang> con) {
        listBarang = con;
...
// Initiate view holder
        if (convertView == null) {
            convertView = mInflater.inflate(android.support.com.project.robert.Robert.R.layout.list_item_order, null);
